...
plots_generator = PlotsGenerator(labels_en_pl_dict_path)

print('Started speech recognition module initialization')
speech_to_text_service = SpeechToTextAlgorithm(text_model_path, lema_dict_path, labels_en_pl_dict_path)
